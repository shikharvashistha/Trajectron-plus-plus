...
def main():
    ...
    # UserWarning: <class 'model.components.gmm2d.GMM2D'> does not define `arg_constraints`. Please set `arg_constraints = {}` or initialize the distribution with `validate_args=False` to turn off validation.
    ...
    train_data_path='/home/shikhar/code/Trajectron-plus-plus/experiments/nuScenes/nuScenes_train_mini_full.pkl'
    ...
    for epoch in range(1, args.train_epochs + 1):
        ...
        #        VISUALIZATION          #
        #################################
        print(f"Starting Visualization @ epoch {epoch}")
...
"""
python train.py --eval_every 10 --vis_every 1 --preprocess_workers 5 --log_dir ../experiments/pedestrians/models --log_tag _eth_ar3 --train_epochs 100 --augment --conf config.json
"""